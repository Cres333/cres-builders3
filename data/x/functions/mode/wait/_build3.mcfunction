...
## 各モードの表示処理
execute if score *mode Grobal matches 0 run function x:display/message/action/build3
execute if score *mode Grobal matches 1 run function x:display/build/action/build3
execute if score *mode Grobal matches 2 run function x:display/tail/action/build3
...
## 待受終了処理
execute if score *end Wait matches 0 run schedule function x:mode/wait/_build3 1s
